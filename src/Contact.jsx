...
const Contact = () => {
  ...
  const formSubmit = (e) => {
    e.preventDefault();
    alert(`My name is ${data.fullName}, My Mobilenumber is ${data.mobile} My email is  ${data.email} And my poblm is  ${data.msg}`)
          ...
          <div className="col-md-6 col-10 mx-auto">
            <form onSubmit={formSubmit}>
              ...
              <div className="mb-3">
                ...
                <input type="Number" className="form-control" id="exampleFormControlInput1" name="mobile" value={data.mobile} onChange={InputEvent} placeholder="Mobile" />
              </div>
              <div className="mb-3">
